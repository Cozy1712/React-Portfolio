        ...
        <div className=' max-w-screen-lg p-6 mx-auto grid grid-flow-row w-full h-full'>
            ...
            <div className='text-justify '>
               <div className=' capitalize item-body flex  flex-col pb-4 py-4 text-gray-300 item-body'>
                    ...
                    <p className='text-justify mt-6 text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic consequatur incidunt cupiditate illum quas eveniet, esse tenetur reprehenderit aperiam! Possimus, sit atque dolor alias aliquam nostrum? Eligendi deleniti tenetur commodi.</p>
                    <h4 className='py-2 mt-6 flex  text-xl '>
                        diploma computer engineering
                    </h4>
                    <p className='flex text-center text-sm py-2'>nuhu bammalli poly . september 2021</p>
                    <p className='text-centre mt-6 text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic consequatur incidunt cupiditate illum quas eveniet, esse tenetur reprehenderit aperiam! Possimus, sit atque dolor alias aliquam nostrum? Eligendi deleniti tenetur commodi.</p>
               </div>
            </div>
        </div>
    </div>
