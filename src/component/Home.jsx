  ...
  return (
    <div name='home' className="bg-hero bg-cover bg-center h-screen bg-fixed">
        <div  className=' item-center text-center justify-center  flex flex-col  md:flex-row h-full px-4'>
            <div className='items-center max-w-screen-lg mx-auto mt-96 md:mt-96 text-center justify-center flex flex-col px-4 '>
                <div className='text-center text-gray-300 capitalize border rounded-xl border-transparent  bg-zinc-800 bg-opacity-50 p-5 '>
                    ...
                    <div className='flex justify-center p-4'>
                        <buttton className= 'cursor-pointer rounded-full w-fit bg-slate-600 text-lg py-2 px-6 flex mx-2 text-center hover:bg-gradient-to-r hover:from-amber-800 hover:to-amber-600 ease-in-out duration-200'> resume
                            <span className='px-1 py-1'>
                            <FiArrowDown/>
                            </span>
                        </buttton> 
                        <buttton className= ' cursor-pointer rounded-full w-fit bg-slate-600 text-lg py-2 px-6 mx-2 text-center hover:bg-gradient-to-r hover:from-amber-800 hover:to-amber-600 ease-in-out duration-200'> conctact
                        </buttton> 
                        
                    </div>
                    
                </div>
                <div className='item-centre justify-center ml-64 mt-72 md:mt-96'>
                    <svg className=' text-white cursor-pointer h-32'>
